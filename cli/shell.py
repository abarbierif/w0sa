import cmd
from core.wss_simulator import WSSimulator
from core.osa_simulator import OSAmulator
from data.config_spectrums import INPUT_SPECTRUMS, OUTPUT_SPECTRUMS, SPECTRUM_DESCRIPTION
import numpy as np
